...
async def emit_batch_processing(session_id: int, batch_id: int, batch_number: int) -> None:
...
async def emit_hop1_progress(session_id: int, batch_id: int, processed: int, total: int, file_name: str) -> None:
...
async def emit_hop2_progress(session_id: int, batch_id: int, processed: int, total: int, file_name: str) -> None:
