                      ...
                      >
                        ...
                        <div className="flex gap-2 ml-6">
                          <button
                            ...
                            className="px-3 py-1.5 bg-action text-white rounded-lg text-xs font-medium hover:bg-action/90 active:scale-[0.95] transition-all"
                          >
                            Continue
                          </button>
                          <button
            ...
            <div className="flex gap-2 ml-6">
              {errorCode === "NO_WSL_DISTRO" ? (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-action text-white rounded-lg text-xs font-medium hover:bg-action/90 active:scale-[0.95] transition-all"
                >
          ...
          >
            <div className="flex items-center gap-3 px-4 py-3 bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800 rounded-lg">
              ...
              <button
                ...
                className="px-3 py-1.5 bg-action hover:bg-action/90 text-white text-xs font-medium rounded-md transition-colors active:scale-[0.95] shrink-0"
              >
                Use as source
              </button>
              <button
