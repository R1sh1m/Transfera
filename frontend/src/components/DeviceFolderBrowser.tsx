...
export function DeviceFolderBrowser({
  ...
  const [selectionMode, setSelectionMode] = useState<"folder" | "file">(
    "folder",
  );
  ...
  const visibleEntries =
    selectionMode === "folder" ? entries.filter((e) => e.is_dir) : entries;
    ...
    <div className="bg-card border border-border rounded-xl overflow-hidden">
      ...
      <div className="px-4 py-3 border-t border-border bg-muted/20">
        <button
          ...
          className="w-full px-4 py-2.5 bg-primary text-primary-foreground rounded-pill text-sm font-normal hover:bg-primary/90 active:scale-[0.95] transition-colors"
        >
          {selectionMode === "folder"
